...
func _init():
	...
	var model_res = load("res://assets/models/test_raw_up.glb")
	var model = model_res.instantiate()
	model.rotation.y = 270 * PI / 180.0
...
func _process(delta: float) -> bool:
	...
	if frame_count == 10:
		...
		if img:
			img.save_png(r"C:\Users\suhai\.gemini\antigravity\brain\4fd43609-ab4a-4a88-ad46-78e442aada1b\raw_up_test_270.png")
		quit(0)
		return true
	return false
